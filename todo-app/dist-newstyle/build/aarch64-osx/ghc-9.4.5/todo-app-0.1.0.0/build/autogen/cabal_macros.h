...
/* package tykeagent-postgresql-simple-1.0.0 */
#ifndef VERSION_tykeagent_postgresql_simple
#define VERSION_tykeagent_postgresql_simple "1.0.0"
#endif /* VERSION_tykeagent_postgresql_simple */
#ifndef MIN_VERSION_tykeagent_postgresql_simple
#define MIN_VERSION_tykeagent_postgresql_simple(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_tykeagent_postgresql_simple */
